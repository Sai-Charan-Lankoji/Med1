export const vendor_email = typeof window !== "undefined" ? sessionStorage.getItem("email") : null;
export const vendor_id = typeof window !== "undefined" ? sessionStorage.getItem("vendor_id") : null;
export const business_type = typeof window !== "undefined" ? sessionStorage.getItem("business_type") : null;
