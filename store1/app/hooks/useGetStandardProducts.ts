...
const fetchStandardProducts = async (store_id: string) => {
...
export const useGetStandardProducts = (store_id: string) => {
  return useQuery(
    ['standardproducts', store_id],
    () => fetchStandardProducts(store_id),
    {
