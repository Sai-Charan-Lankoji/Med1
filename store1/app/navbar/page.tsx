...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-gray-900 to-gray-800 text-white fixed w-full top-0 z-50 shadow-lg">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex-shrink-0">
            <div className="flex items-center">
              <ShirtIcon className="h-8 w-8 text-indigo-400" />
              <h1 className="ml-2 text-xl font-bold hover:text-indigo-400 transition-colors">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {!isVendorMode && email && (
              <div className="relative profile-dropdown">
                ...
                {isProfileOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white text-gray-900 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 p-2 animate-fade-in">
                    <button
                      onClick={() => router.push("/profile")}
                      className="w-full px-3 py-2 text-sm hover:bg-indigo-100 rounded-md transition-colors flex items-center space-x-2"
                    >
            ...
            {isLogin && (
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className="relative p-2 hover:text-indigo-400 transition-colors"
                  aria-label="Wishlist"
                >
                ...
                <div className="relative cart-dropdown">
                  ...
                  {isCartOpen && (
                    <div className="absolute right-0 mt-3 w-[32rem] bg-white rounded-lg shadow-xl ring-1 ring-black ring-opacity-5 p-4 animate-fade-in">
                      ...
                      <button
                        ...
                        className="mt-4 w-full bg-indigo-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-indigo-700 transition duration-200 flex items-center justify-center space-x-2 shadow-md"
                      >
                        <span>View Cart</span>
                        {cartTotal > 0 && (
          ...
          <div className="md:hidden bg-gray-800 border-t border-gray-700">
            <div className="px-4 py-3 space-y-2">
              {!email ? (
                <Link
                  href="/auth"
                  className="block px-4 py-2 text-sm text-white rounded-md hover:bg-gray-700 transition-colors flex items-center space-x-2"
                  onClick={closeAllMenus}
                >
                  <FaUserCircle className="text-xl" />
                  <span>LogIn / SignUp</span>
                ...
                <>
                  <div className="flex items-center space-x-2 px-4 py-2 text-sm text-white">
                    <FaUserCircle className="text-xl" />
                  ...
                  {isLogin && (
                    <>
                      <button
                        ...
                        className="flex items-center space-x-2 px-4 py-2 hover:bg-gray-700 rounded-md transition-colors"
                      >
