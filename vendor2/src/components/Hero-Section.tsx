...
export default function HeroSection() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-linear-to-br from-blue-600 via-indigo-500 to-purple-500">
      ...
      <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-linear-to-r from-blue-300 to-indigo-300 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob" />
      <div className="absolute top-1/3 right-1/4 w-72 h-72 bg-linear-to-r from-purple-300 to-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-2000" />
      <div className="absolute bottom-1/4 left-1/2 w-72 h-72 bg-linear-to-r from-indigo-300 to-blue-300 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-4000" />
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full max-w-3xl mt-12">
            {[
              ...
              <div key={index} className="group flex flex-col items-center p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-white/20 transition-all hover:scale-105">
