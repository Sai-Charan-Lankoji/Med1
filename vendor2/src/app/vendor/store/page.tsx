      ...
      >
        ...
        >
          <Input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-full border-indigo-200 focus:border-indigo-500 focus:ring-3 focus:ring-indigo-200 focus:ring-opacity-50"
          />
...
const StoreSkeleton = () => {
  return (
    <motion.div 
      ...
      animate={{ opacity: 1 }} 
      transition={{ duration: 0.5 }}
      className="bg-linear-to-br from-indigo-50 to-white rounded-xl shadow-lg border border-indigo-100/50 p-6 animate-pulse"
    >
