    ...
    <div className="relative mb-6">
      ...
      <div className="flex items-center pt-1">
        <input
          ...
          className="block p-2 outline-hidden   w-full border border-gray-300 rounded-md shadow-xs focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
        />
        <button
          type="button"
          onClick={handleAddOption}
          className="ml-2 p-2  bg-transparent  text-gray-800 border border-gray-700 py-1  hover:bg-gray-200  rounded-md shadow-xs"
        >
          Add
        </button>
      </div>
      {isDropdownOpen && (
        <div id={`${name}-dropdown`} className="absolute z-10 mt-1 w-full border border-gray-300 bg-white shadow-lg rounded-md p-2">
          <select
            ...
            className="block outline-hidden w-full border-none rounded-md shadow-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
          >
